...
export default function AccountStationPrototype({ open = true, onClose, onLaunchGame, telegramUser }) {
  ...
  return (
    <main style={styles.root}>
      ...
      {!active && (
        <div style={styles.cameraHint}>ПРОВЕРКА: НАБЛЮДАТЕЛЬ СДВИНУТ ВПРАВО</div>
      )}
...
const styles = {
  ...
  stationModel:{ position:"absolute", inset:0, width:"100%", height:"100%", transform:"translateX(-62vw) scale(1.6)", transformOrigin:"50% 55%", background:"radial-gradient(circle at 48% 42%,#07152b 0,#020713 42%,#010207 76%)", touchAction:"none" },
